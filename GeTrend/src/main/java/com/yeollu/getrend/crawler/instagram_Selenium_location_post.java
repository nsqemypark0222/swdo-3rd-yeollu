...
//		options.addArguments("headless");
	...
	private instagram_Selenium_location_post() {
		
	}
	
	private static class InnerInstance_instagram_Selenium_location_post {
		private static final instagram_Selenium_location_post instance = new instagram_Selenium_location_post();
	}
	
	public static instagram_Selenium_location_post getInstance() {
		return InnerInstance_instagram_Selenium_location_post.instance;
	}
