...
import com.yeollu.getrend.store.util.preprocess.model.Morpheme;
import com.yeollu.getrend.store.util.preprocess.model.NameEntity;
import com.yeollu.getrend.util.PropertiesUtil;

public class WiseNLU {
	private static final Logger logger = LoggerFactory.getLogger(WiseNLU.class);
	
	private final String openApiURL = PropertiesUtil.get("wisenlu", "WISE_NLU_OPENAPIURL");
	private final String accessKey = PropertiesUtil.get("wisenlu", "WISE_NLU_ACCESSKEY");
	private final String analysisCode = PropertiesUtil.get("wisenlu", "WISE_NLU_ANALYSISCODE");
